    ...
    <Container>
      ...
      >
        ...
        <InfoSection title="Personal Information">
          ...
          <Info
            label="Date of Birth"
            value={new Date(member.dob).toLocaleDateString()}
          />
        </InfoSection>
          ...
          {member.payments.length === 0 ? (
            ...
            >
              ...
              >
                ...
                <tbody>
                  {member.payments.map((payment: any, index: number) => (
                    <motion.tr
                      key={payment.id}
                      initial={{
                        opacity: 0,
                    ...
                    >
                      ...
                      <td className="p-4">৳ {payment.fine}</td>

                      <td className="p-4 font-semibold">৳ {payment.total}</td>
